...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
<link rel="stylesheet" href="packages/fonts/fontawesome.min.css">
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.0.13/css/all.css"
      integrity="sha384-DNOHZ68U8hZfKXOrtjWvjxusGo9WQnrNx2sqG0tfsghAvtVlRW3tvkXWZh58N9jp" crossorigin="anonymous">
<link rel="stylesheet" href="packages/bootstrap-4.1.1/dist/css/bootstrap.min.css">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                if (isset($_SESSION['login']) && isset($_SESSION['pass'])) {
                    ...
                    echo "<li class='nav-item'><a class='nav-link' href='/public/login.php?action=logout'>Выйти ($login)</a></li>";
                } else {
